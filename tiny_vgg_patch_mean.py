# -*- coding: utf-8 -*-
"""tiny_vgg_patch_mean.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13lTsY0nMqEvKZNLVjGRT7Lt7u2Q3JKqS
...
class net(nn.Module):
    ...
    def forward(self, x_cnn):
        ...
        for x_cnn_sample in x_cnn:
          ...
          y_cnn_embedding = (torch.mean(self.cnn_2(self.cnn_1(x_cnn_sample)), dim=0))
...
torch.save(data_dict, 'tiny_vgg_patch_mean.pth')
